  ...
  <div class="report-container">
    ...
    <div class="section">
      ...
      <div class="info-grid">
        ...
        <div class="info-item"><div class="info-label">Subject</div><div class="info-value">${data.subject}</div></div>
        <div class="info-item"><div class="info-label">Experience</div><div class="info-value">${data.experience} Years</div></div>
      </div>
    </div>
